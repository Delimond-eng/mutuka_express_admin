            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-12 mt-80 sm-mt-0">
                    ...
                    <div id="booking_form_wrap" class="padding40 rounded-5 shadow-soft" data-bgcolor="#ffffff">
                        ...
                        <form name="contactForm" id='booking_form' class="form-s2 row g-4 on-submit-hide" method="post" action="https://www.madebydesignesia.com/themes/rentaly/booking.php">

                            <div class="col-lg-6 d-light">
                                <h4>Sélection un véhicule</h4>
                                <select name='vehicle_type' id="vehicle_type" class="form-control">
                                    <option value='Jeep Renegade' data-src="assets2/images/cars-alt/jeep-renegade.png">Jeep Renegade - $265</option>
                                    <option value='BMW M5' data-src="assets2/images/cars-alt/bmw-m5.png">BMW M5 - $544</option>
                                    <option value='Ferrari Enzo' data-src="assets2/images/cars-alt/ferrari-enzo.png">Ferrari Enzo - $167</option>
                                    <option value='Ford Raptor' data-src="assets2/images/cars-alt/ford-raptor.png">Ford Raptor - $147</option>
                                    <option value='Mini Cooper' data-src="assets2/images/cars-alt/mini-cooper.png">Mini Cooper - $238</option>
                                    <option value='Cheverolet Camaro' data-src="assets2/images/cars-alt/vw-polo.png">Cheverolet Camaro - $245</option>
                                    <option value='Hyundai Staria' data-src="assets2/images/cars-alt/hyundai-staria.png">Hyundai Staria - $191</option>
                                    <option value='Toyota Rav 4' data-src="assets2/images/cars-alt/toyota-rav.png">Toyota Rav 4 - $114</option>
                                    <option value='Bentley' data-src="assets2/images/cars-alt/bentley.png">Bentley - $299</option>
                                    <option value='Lexus' data-src="assets2/images/cars-alt/lexus.png">Lexus - $131</option>
                                    <option value='Range Rover' data-src="assets2/images/cars-alt/range-rover.png">Range Rover - $228</option>
                                </select>
                            ...
                            <div class="col-lg-6">
                                <h4>Entrez vos infos personnelles</h4>
                                <div class="row g-4">
                                    <div class="col-lg-12">
                                        <div class="field-set">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="field-set">
                                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Téléphone" required>
                                        </div>
                                    </div>

                                    <div class="col-lg-12">
                                        <div class="field-set">
                                            <textarea name="message" id="message" class="form-control" placeholder="Une requête particulière?"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3">
                                <p id='submit'>
                                    <input type='submit' id='send_message' value='Soumettre' class="btn-main btn-fullwidth">
                                </p>
