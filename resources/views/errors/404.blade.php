...
<head>
    ...
    <link rel="icon" href="assets2/images/icon.png" type="image/gif" sizes="16x16">
    ...
    <!-- countdown -->
    <link id="colors" href="assets2/css/jquery.countdown.css" rel="stylesheet" type="text/css" />
</head>
            ...
            <section id="section-hero" class="jarallax text-light pt50 pb50 vertical-center" aria-label="section">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <h1>Une Requête erronée !</h1>
                            <p>Il semble que cette page soit manquante. Ne vous inquiétez pas, notre meilleure équipe est sur le coup.</p>
