...
@section("content")
    ...
    <div class="no-bottom no-top" id="content">
                        ...
                        @for ($i=0; $i<10; $i++)
                            <div class="col-lg-12">
                                <div class="de-item mb30">
                                    <div class="d-img">
                                        <img src="assets2/images/cars/jeep-renegade.jpg" class="img-fluid" alt="">
                                    </div>
                                    <div class="d-info">
                                        <div class="d-text">
                                            <h4>Jeep Renegade</h4>
                                            ...
                                            <div class="d-atr-group">
                                                ...
                                                <span class="d-atr"><img src="assets2/images/icons/4-green.svg" alt="">SUV</span>
                                            </div>
                                            <div class="d-price">
                                                Daily rate from <span>$265</span>
                                                <a class="btn-main" href="{{ url("car_details") }}">Reservez maintenant</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section id="section-img-with-tab" data-bgcolor="#f8f8f8">
            ...
            <div class="image-container col-md-6 pull-right" data-bgimage="url(assets2/images/background/6.jpg) center"></div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="de-image-text">
                            ...
                            <img src="assets2/images/testimonial/1.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="de-image-text">
                            ...
                            <img src="assets2/images/testimonial/2.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="de-image-text">
                            ...
                            <img src="assets2/images/testimonial/3.jpg" class="img-fluid" alt="">
                        </div>
                    </div>
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="assets2/images/news/pic-blog-1.jpg" class="lazy">
                                </div>
                                <div class="post-text">
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="assets2/images/news/pic-blog-2.jpg" class="lazy">
                                </div>
                                <div class="post-text">
                        ...
                        <div class="bloglist s2 item">
                            <div class="post-content">
                                <div class="post-image">
                                    ...
                                    <img alt="" src="assets2/images/news/pic-blog-3.jpg" class="lazy">
                                </div>
                                <div class="post-text">
